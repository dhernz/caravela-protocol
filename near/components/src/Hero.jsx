        ...
        <div className="row hero-content">
          <div className="hero-data">
            <h1 className="hero-title">
              Hi, it's{" "}
              <span style={{ color: "var(--first-color)" }}>Caravela</span>
            </h1>
            <h3 className="hero-subtitle">
              Composable protocol for Decentralized Customer dApps
            </h3>
            <p className="hero-description">
              Build decentralized Customer Apps seamlessly from the most popular modules.{" "}
            </p>
            <ButtonStyle>
